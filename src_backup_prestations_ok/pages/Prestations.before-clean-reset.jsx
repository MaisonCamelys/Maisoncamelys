...
function SectionHeader({ label, title, text, centered = false, maxWidth = 'max-w-4xl' }) {
  return (
    <div className={[centered ? 'mx-auto text-center' : '', maxWidth].join(' ')}>
      ...
      <h2
        className="mt-4 text-[clamp(1.9rem,3vw,3.2rem)] leading-[1.1] text-[#1F1D1A]"
...
export default function Prestations() {
  ...
  return (
    <main className="bg-[#F7F3EE] text-[#1F1D1A]">
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            className="h-[72vh] min-h-[620px] w-full object-cover object-center md:h-[78vh]"
          />
          <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(18,18,16,0.30),rgba(18,18,16,0.58))]" />
        </div>

        <div className="relative mx-auto flex min-h-[72vh] w-[min(1200px,calc(100%-2rem))] items-end py-14 md:w-[min(1200px,calc(100%-3rem))] md:py-16">
          <div className="max-w-[680px] text-[#FCFAF7]">
            <p className="reveal text-[11px] uppercase tracking-[0.24em] text-[#D8B36A]">
              Nos accompagnements
            </p>

            <h1
              className="reveal mt-5 max-w-[640px] text-[clamp(2.7rem,4.8vw,4.9rem)] leading-[1.02]"
              style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
            >
              Une présence pensée pour alléger, tenir et sublimer votre journée.
            </h1>

            <p className="reveal mt-6 max-w-[560px] text-[15px] leading-8 text-[#F1EBE2] md:text-[17px]">
      ...
      <section id="experience" className="relative z-10 -mt-6 pb-10 md:-mt-10 md:pb-14">
        <div className="mx-auto w-[min(1100px,calc(100%-2rem))] md:w-[min(1120px,calc(100%-3rem))]">
          <div className="reveal rounded-[28px] border border-[#DDD4C9] bg-[#FCFAF7]/94 px-6 py-7 shadow-[0_10px_32px_rgba(31,29,26,0.05)] backdrop-blur-sm md:px-10 md:py-9">
            <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:gap-12">
              <div>
                ...
                <h2
                  className="mt-4 max-w-[700px] text-[clamp(2rem,3.2vw,3.5rem)] leading-[1.08] text-[#1F1D1A]"
                  style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
                >
              ...
              <div className="flex items-end">
                <p className="max-w-[420px] text-[15px] leading-8 text-[#5F5952]">
        ...
        <div className="mx-auto w-[min(1120px,calc(100%-2rem))] md:w-[min(1120px,calc(100%-3rem))]">
          <div className="reveal mb-14 md:mb-20">
            <SectionHeader
              ...
              title="Une présence fluide, pensée pour accompagner sans jamais alourdir."
          ...
          <article className="reveal grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-14">
            ...
            <div className="pb-2">
              ...
              <h3
                className="mt-4 max-w-[520px] text-[clamp(2rem,3vw,3.3rem)] leading-[1.08] text-[#1F1D1A]"
                style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
              >
                {orchestration.title}
              </h3>
          ...
          <div className="mt-20 grid gap-14 lg:grid-cols-2">
            <article className="reveal">
              ...
              <div className="mt-8">
                ...
                <h3
                  className="mt-4 max-w-[500px] text-[clamp(1.8rem,2.5vw,2.7rem)] leading-[1.1] text-[#1F1D1A]"
                  style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
                >
                  {enfants.title}
                </h3>
        ...
        <div className="mx-auto w-[min(1120px,calc(100%-2rem))] md:w-[min(1120px,calc(100%-3rem))]">
          <article className="reveal relative overflow-hidden rounded-[34px] border border-[#D7CFC4] bg-[#1F2619]">
            ...
            <div className="relative px-6 py-12 text-[#FCFAF7] md:px-12 md:py-16 lg:w-[58%] lg:px-16 lg:py-20">
              ...
              <h3
                className="mt-4 max-w-[520px] text-[clamp(1.9rem,3vw,3rem)] leading-[1.08]"
                style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
              >
                {soiree.title}
              </h3>
      ...
      <section className="pb-20 md:pb-28">
        <div className="mx-auto grid w-[min(1120px,calc(100%-2rem))] gap-6 md:w-[min(1120px,calc(100%-3rem))] lg:grid-cols-2">
          <article className="reveal rounded-[30px] border border-[#DDD4C9] bg-[#FCFAF7] px-6 py-8 md:px-9 md:py-10">
            ...
            <h3
              className="mt-4 max-w-[520px] text-[clamp(1.9rem,2.8vw,3rem)] leading-[1.08] text-[#1F1D1A]"
              style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
            >
          ...
          <article className="reveal rounded-[30px] border border-[#DDD4C9] bg-[#F4EEE4] px-6 py-8 md:px-9 md:py-10">
            ...
            <h3
              className="mt-4 max-w-[480px] text-[clamp(1.8rem,2.5vw,2.8rem)] leading-[1.1] text-[#1F1D1A]"
              style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
            >
      ...
      <section className="pb-24 md:pb-32">
        <div className="mx-auto w-[min(980px,calc(100%-2rem))] md:w-[min(980px,calc(100%-3rem))]">
          <div className="reveal rounded-[34px] border border-[#DDD4C9] bg-[#FCFAF7] px-6 py-10 text-center shadow-[0_14px_40px_rgba(31,29,26,0.05)] md:px-12 md:py-14">
            ...
            <h2
              className="mx-auto mt-4 max-w-[760px] text-[clamp(2rem,3vw,3.4rem)] leading-[1.1] text-[#1F1D1A]"
              style={{ fontFamily: 'var(--serif)', fontWeight: 400 }}
            >
